...
const services = [{
  ...
  features: ["Responsive design for all devices", "Content management systems", "Custom functionality and integrations", "SEO-optimized architecture"]
}, {
  id: 2,
  ...
  features: ["Profile optimization", "Photo and content management", "Review management", "Regular updates and posts"]
}, {
  id: 3,
  ...
  features: ["Digital transformation roadmaps", "Competitive analysis", "Growth strategy development", "Performance tracking frameworks"]
}, {
  id: 4,
  icon: <Search size={32} />,
  ...
  features: ["Technical SEO review", "Content quality assessment", "User experience evaluation", "Actionable recommendations"]
}, {
  id: 5,
  icon: <Users size={32} />,
  title: "Social Media Marketing",
  description: "Strategic social media campaigns that build engagement, strengthen brand loyalty, and drive conversions.",
  features: ["Platform-specific strategies", "Content calendar development", "Community management", "Paid social campaigns"]
}, {
  id: 6,
  icon: <Mail size={32} />,
  title: "Email Marketing",
  description: "Targeted email campaigns that nurture leads, drive sales, and build lasting customer relationships.",
  features: ["List building strategies", "Campaign design and copywriting", "Automation sequences", "Performance analytics"]
}, {
  id: 7,
  icon: <TrendingUp size={32} />,
  title: "Performance Marketing",
  description: "Data-driven campaigns focused on delivering measurable results and maximizing your marketing ROI.",
  features: ["PPC campaign management", "Conversion rate optimization", "Retargeting strategies", "ROI tracking and reporting"]
}, {
  id: 8,
  icon: <FileText size={32} />,
  title: "Content & Copywriting",
  description: "Compelling content that tells your brand story, engages your audience, and drives action.",
  features: ["Website copywriting", "Blog content creation", "SEO content strategy", "Brand messaging development"]
}, {
  id: 9,
  icon: <Camera size={32} />,
  title: "Content Production",
  description: "High-quality visual content that captures attention and communicates your brand message effectively.",
  features: ["Photography", "Video production", "Graphic design", "Social media assets"]
}, {
  id: 10,
  icon: <Star size={32} />,
  ...
  features: ["Review solicitation campaigns", "Response management", "Reputation monitoring", "Negative review mitigation"]
}];
const Services = () => {
  return <div className="pt-20 min-h-screen">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="opacity-0 animate-fade-in animate-delay-300">
              <CTAButton text="Book a Free Consultation" to="/contact" size="lg" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 md:px-6">
          <SectionHeader subtitle="What We Offer" title="Comprehensive Digital Marketing Services" description="Each service is designed to address specific aspects of your digital presence and overall business growth." center={true} />
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12 mt-12">
            {services.map((service, index) => <div key={service.id} className={`opacity-0 animate-fade-in animate-delay-${index % 5}00`}>
      ...
      <section className="py-16 bg-black text-white">
        <div className="container mx-auto px-4 md:px-6">
          <SectionHeader subtitle="Our Approach" title="How We Deliver Results" description="Our proven process ensures we deliver consistent value and results for every client." center={true} className="text-white" />
