...
const About = () => {
  return <div className="pb-0 min-h-screen">
      ...
      <section className="py-16 bg-hustle-muted">
        <div className="container mx-auto px-4 md:px-6">
          <SectionHeader subtitle="What We're About" title="Our Mission" description={<div className="space-y-4">
                <p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            ...
            <ServiceCard icon={<Globe className="text-hustle-accent" />} title="Google My Business Setup & Management" description="Be seen where it matters most—locally and on the map." delay={100} />
            
            <ServiceCard icon={<Settings className="text-hustle-accent" />} title="Business Strategy Consulting" description="Because tactics without a strategy? Useless. We help you zoom out before we zoom in." delay={200} />
            
            <ServiceCard icon={<Wrench className="text-hustle-accent" />} title="Free Website Audit" description="Real talk: We'll tell you what's working, what's broken, and how to fix it—on the house." delay={300} />

            <ServiceCard icon={<Smartphone className="text-hustle-accent" />} title="Social Media Marketing" description="Not just likes and shares. We build brand stories that get traction and drive action." delay={400} />

            <ServiceCard icon={<Mail className="text-hustle-accent" />} title="Email Marketing" description="Inbox domination with campaigns that feel personal and perform like crazy." delay={500} />

            <ServiceCard icon={<Target className="text-hustle-accent" />} title="Performance Marketing" description="Click, convert, repeat. Data-driven campaigns that stretch every dollar." delay={600} />

            <ServiceCard icon={<PenTool className="text-hustle-accent" />} title="Content & Copywriting" description="Words that work. From landing pages to social captions, we make every line count." delay={700} />

            <ServiceCard icon={<MessageSquare className="text-hustle-accent" />} title="Content Production" description="Photo, video, audio—we create content people stop scrolling for." delay={800} />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="w-full lg:w-1/2">
              <SectionHeader subtitle="The Hustle Difference" title="What Sets Us Apart" description={<div className="space-y-4">
                    <p>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center opacity-0 animate-fade-in animate-delay-200">
              <CTAButton text="Contact Us" to="/contact" variant="white" size="lg" />
              <CTAButton text="View Our Services" to="/services" variant="outline" size="lg" className="text-white" />
            </div>
          </div>
        </div>
      </section>
