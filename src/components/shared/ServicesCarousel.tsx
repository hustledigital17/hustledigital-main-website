    ...
    >
      ...
      >
        ...
        <div className="flex justify-center mt-4">
          <CarouselPrevious className="static transform-none mx-2 hover:bg-hustle-accent hover:text-white transition-colors duration-300" />
          <CarouselNext className="static transform-none mx-2 hover:bg-hustle-accent hover:text-white transition-colors duration-300" />
        </div>
      </Carousel>
    </motion.div>
  );
